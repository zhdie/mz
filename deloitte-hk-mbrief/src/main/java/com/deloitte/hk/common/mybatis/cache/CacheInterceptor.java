package com.deloitte.hk.common.mybatis.cache;
...
import com.deloitte.hk.common.mybatis.mapper.builder.SqlBuilder;
import com.deloitte.hk.common.mybatis.page.PageParameter;
                        ...
                        try {
                            ...
                            if (value != null) {
                                ...
                                if (null != originalPage) {
                                    ...
                                    long totalPage = totalCount / originalPage.getPageSize()
